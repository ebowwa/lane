...
exports.registerSwitchCommand = registerSwitchCommand;
...
function registerSwitchCommand(program) {
    ...
    program
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, lanes_js_1.getLaneForSwitch)(name)];
                case 1:
                    lane = _a.sent();
                    if (!lane) {
                        console.error(chalk_1.default.red("Error: Lane \"".concat(name, "\" not found")));
                        process.exit(1);
                    }
