...
var Settings_js_1 = require("../../ui/Settings.js");
...
function registerConfigCommand(program) {
    ...
    program
        ...
        var mainRoot, config, waitUntilExit;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    config = _a.sent();
                    waitUntilExit = (0, utils_js_1.renderUI)(react_1.default.createElement(Settings_js_1.Settings, {
                        ...
                        onSave: function (settings) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        _a.sent();
                                        console.error(chalk_1.default.green("✓ Settings saved"));
                                        return [2 /*return*/];
                                }
                            });
                        }); },
