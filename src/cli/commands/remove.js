            ...
            switch (_a.label) {
                case 0:
                    if (name === "main" || name === "origin") {
                        console.error(chalk_1.default.red("Error: Cannot remove the main repository"));
                        process.exit(1);
                    }
                    console.log(chalk_1.default.blue("Removing lane \"".concat(name, "\"...")));
                    return [4 /*yield*/, (0, lanes_js_1.removeLaneCmd)(name, {
                ...
                case 1:
                    ...
                    console.log(chalk_1.default.green("Lane \"".concat(name, "\" removed successfully!")));
                    return [2 /*return*/];
            }
        });
    }); });
